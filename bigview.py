...
st.sidebar.text("eKYC BigVision Ver 1.0.0")
st.sidebar.link_button("Go to API page", "https://www.apilogy.id/api/detail/bigvision/name/ekyc-ktp-extraction/version/1.0.0")
api_key = st.sidebar.text_input("Apilogy API Key")
# Instructions
